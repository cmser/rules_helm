...
PLATFORMS = {
    "darwin-arm64": struct(
        ...
        url = "https://get.helm.sh/helm-{}-darwin-arm64.tar.gz",
    ...
    "darwin-x64": struct(
        ...
        url = "https://get.helm.sh/helm-{}-darwin-amd64.tar.gz",
    ...
    "linux-arm64-gnu": struct(
        ...
        url = "https://get.helm.sh/helm-{}-linux-arm64.tar.gz",
    ...
    "linux-x64-gnu": struct(
        ...
        url = "https://get.helm.sh/helm-{}-linux-amd64.tar.gz",
    ...
    "win32-x64-msvc": struct(
        ...
        url = "https://get.helm.sh/helm-{}-windows-amd64.zip",
...
def _resolved_toolchain_impl(ctx):
    toolchain_info = ctx.toolchains["@com_github_cmser_rules_helm//toolchain:toolchain_type"]
    return [
        toolchain_info
    ]
...
toolchain(
    ...
    toolchain_type = "@com_github_cmser_rules_helm//toolchain:toolchain_type",
)
""".format(
            platform = platform,
